...
<main class="profile-page">
  <section class="relative block" style="height: 500px;">
    <div
      ...
      style='background-image: url("{{ public_asset("/assets/ita/images/profile-default-bg.jpg")  }}");'
    >
          <span
            id="blackOverlay"
        ...
        <div class="px-6">
            ...
            <div class="w-full lg:w-4/12 px-4 lg:order-1">
              <div class="flex justify-center py-4 lg:pt-4 pt-8">
                <div class="mr-4 p-3 text-center">
                      ...
                      >{{ $user->flights}}</span
                      ><span class="text-sm text-gray-500">@lang('flights.flights')</span>
                </div>
                <div class="mr-4 p-3 text-center">
                      <span
                        class="text-xl font-bold block uppercase tracking-wide text-gray-700"
                      >@minutestotime($user->flight_time)</span
                      ><span class="text-sm text-gray-500">@lang('flights.flighthours')</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-10 py-10 border-t border-gray-300 text-center">
            <div class="flex flex-wrap justify-center">
              ...
              {{--                    </td>--}}
              {{--                    <td><span id="apiKey_show" style="display: none">{{ $user->api_key }} <i class="fas fa-eye-slash"--}}
              {{--                                                                                             onclick="apiKeyHide()"></i></span><span--}}
              {{--                        id="apiKey_hide">@lang('profile.apikey-show') <i class="fas fa-eye" onclick="apiKeyShow()"></i></span>--}}
              {{--                    </td>--}}
              {{--                  </tr>--}}
              {{--                  <tr>--}}
